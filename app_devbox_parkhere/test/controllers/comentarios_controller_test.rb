...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { calificacion: @comentario.calificacion, comentario: @comentario.comentario, estacionamiento: @comentario.estacionamiento, usuario: @comentario.usuario } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { calificacion: @comentario.calificacion, comentario: @comentario.comentario, estacionamiento: @comentario.estacionamiento, usuario: @comentario.usuario } }
